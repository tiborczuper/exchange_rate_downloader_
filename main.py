...
timestamp_cl_date = timestamp_convert(timestamp_cl)
timestamp_oexr_date = timestamp_convert(timestamp_oexr) #unix timestamp to datetime

print(f"TIMESTAMP: {timestamp_cl_date}")
for v in data_cl.items():
    print(v)
print()

print(f"TIMESTAMP: {timestamp_oexr_date}")
